...
impl Stopwatch {
	pub fn new() -> Stopwatch {
		...
		Stopwatch{ start: time, stop: time }
	}
...
fn test_format_duration_16() {
	...
	assert_eq!(duration_str(&Duration::nanoseconds(1_234_444_499_999_999)), "1 234 444 s");
	assert_eq!(duration_str(&Duration::nanoseconds(1_234_444_500_000_000)), "1 234 445 s");
	assert_eq!(duration_str(&Duration::nanoseconds(9_999_999_499_999_999)), "9 999 999 s");
}

#[test]
fn test_format_duration_17() {
	assert_eq!(duration_str(&Duration::nanoseconds(9_999_999_500_000_000)), "10 000 000 s");
	assert_eq!(duration_str(&Duration::nanoseconds(12_344_444_499_999_999)), "12 344 444 s");
	assert_eq!(duration_str(&Duration::nanoseconds(12_344_444_500_000_000)), "12 344 445 s");
	assert_eq!(duration_str(&Duration::nanoseconds(99_999_999_499_999_999)), "99 999 999 s");
}

#[test]
fn test_format_duration_18() {
	assert_eq!(duration_str(&Duration::nanoseconds(99_999_999_500_000_000)), "100 000 000 s");
	assert_eq!(duration_str(&Duration::nanoseconds(123_444_444_499_999_999)), "123 444 444 s");
	assert_eq!(duration_str(&Duration::nanoseconds(123_444_444_500_000_000)), "123 444 445 s");
	assert_eq!(duration_str(&Duration::nanoseconds(999_999_999_499_999_999)), "999 999 999 s");
}

#[test]
fn test_format_duration_19() {
	assert_eq!(duration_str(&Duration::nanoseconds(999_999_999_500_000_000)), "1 000 000 000 s");
	assert_eq!(duration_str(&Duration::nanoseconds(1_234_444_444_499_999_999)), "1 234 444 444 s");
	assert_eq!(duration_str(&Duration::nanoseconds(1_234_444_444_500_000_000)), "1 234 444 445 s");
	assert_eq!(duration_str(&Duration::microseconds(9_999_999_999_499_999)), "9 999 999 999 s");
}

#[test]
fn test_format_duration_20() {
	assert_eq!(duration_str(&Duration::microseconds(9_999_999_999_500_000)), "10 000 000 000 s");
	assert_eq!(duration_str(&Duration::microseconds(12_344_444_444_499_999)), "12 344 444 444 s");
	assert_eq!(duration_str(&Duration::microseconds(12_344_444_444_500_000)), "12 344 444 445 s");
	assert_eq!(duration_str(&Duration::microseconds(99_999_999_999_499_999)), "99 999 999 999 s");
}

#[test]
fn test_format_duration_21() {
	assert_eq!(duration_str(&Duration::microseconds(99_999_999_999_500_000)), "100 000 000 000 s");
	assert_eq!(duration_str(&Duration::microseconds(123_444_444_444_499_999)), "123 444 444 444 s");
	assert_eq!(duration_str(&Duration::microseconds(123_444_444_444_500_000)), "123 444 444 445 s");
	assert_eq!(duration_str(&Duration::microseconds(999_999_999_999_499_999)), "999 999 999 999 s");
}

#[test]
fn test_format_duration_22() {
	assert_eq!(duration_str(&Duration::microseconds(999_999_999_999_500_000)), "1 000 000 000 000 s");
	assert_eq!(duration_str(&Duration::microseconds(1_234_444_444_444_499_999)), "1 234 444 444 444 s");
	assert_eq!(duration_str(&Duration::microseconds(1_234_444_444_444_500_000)), "1 234 444 444 445 s");
	assert_eq!(duration_str(&Duration::milliseconds(9_999_999_999_999_499)), "9 999 999 999 999 s");
}
